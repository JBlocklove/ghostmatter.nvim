...
Plug 'JBlocklove/moonlight.nvim'
```

```lua
-- If you are using Packer
use 'JBlocklove/moonlight.nvim'
```
...
| moonlight_disable_background         | `false`     | Disable the setting of background color so that NeoVim can use your terminal background (Not all plugins supported)
